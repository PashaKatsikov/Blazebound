...
const String homeLink = 'https://blazebound.link'; // [FORGE]
const String privacyLink = 'https://blazebound.link/privacy-policy'; // [FORGE]
const String supportLink = 'https://blazebound.link/support'; // [FORGE]
